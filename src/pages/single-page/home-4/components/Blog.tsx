...
const latesData = [
  { image: blog7, description: 'Electricity Empowerment: Insights & Innovations' },
  { image: blog8, description: 'Energize Chronicles: Stories from the Energy Frontier' },
  { image: blog9, description: 'Illuminate Intelligence: Bright Ideas in Energy' },
]

const Blog = () => {
  return (
    <>
      <div className="blog3-section-area sp2" id="blog">
        <Container>
          <Row>
