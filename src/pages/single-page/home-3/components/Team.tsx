...
const teamData: TeamType[] = [
  { image: team5, name: 'Kore Anderson', role: 'Team Leader' },
  { image: team6, name: 'Zara Matheson', role: 'Team Leader' },
  { image: team7, name: 'Kore Anderson', role: 'Team Leader' },
]

const Team = () => {
  return (
    <>
      <div className="team2-section-area sp2" id="team">
        <Container>
          <Row>
          ...
          <Row>
            {teamData.map((item, idx) => (
              <Col key={idx} lg={4} md={6} data-aos="flip-right" data-aos-duration={800 + idx * 200}>
