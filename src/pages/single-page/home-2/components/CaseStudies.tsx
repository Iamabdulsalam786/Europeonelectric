...
const caseData = [
  { image: img7, icon: icon1, title: 'Eco-Electric Chronicles' },
  { image: img8, icon: icon2, title: 'Bright Spark Services' },
  { image: img9, icon: icon3, title: 'Best Power and Progress' },
]

const CaseStudies = () => {
  return (
    <>
      <div className="casestudy4-section-area sp2" id="case">
        <Container>
          <Row>
