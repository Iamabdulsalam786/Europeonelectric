...
const newsData = [
  ...
  { image: blog12, title: 'Spark Connections: Engage with Our Energy ', name: 'Join us as we explore topics ranging from renewable energy sources.' },
]
        ...
        <Container>
          ...
          <Row>
            {newsData.map((item, idx) => (
              <Col lg={4} md={6} key={idx} data-aos="flip-right" data-aos-duration={800 + idx * 200}>
