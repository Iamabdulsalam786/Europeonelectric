...
const About = () => {
  return (
    <>
      <div className="about4-section-area sp1" id="about">
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="about-header-area heading9">
                ...
                <h2 className="tg-element-title">Empowering Communities with Sustainable Energy</h2>
                <p data-aos="fade-left" data-aos-duration={1000}>
                  Our team of experienced professionals is driven by a shared vision of creating a brighter, cleaner future through innovative
