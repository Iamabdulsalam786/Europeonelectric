    ...
    <>
      <div className="blog-leftside-section-area sp8">
        <Container>
          <Row>
            <Col lg={8}>
              <div className="blog-leftside-area heading2 blog-rightside">
              ...
              <div className="blog-auhtor-side-area">
                ...
                <div className="blog-author-list">
                  ...
                  <ul>
                    <li>
                      <Link to="">
                        Voltage Vision <FaArrowRight />
                      </Link>
                    </li>
                    <li>
                      <Link to="">
                        Power Grid Expansion <FaArrowRight />
                      </Link>
                    </li>
                    <li>
                      <Link to="">
                        Best Power and Progress <FaArrowRight />
                      </Link>
                    </li>
                    <li>
                      <Link to="">
                        Electrifying Results <FaArrowRight />
                      </Link>
                    </li>
                    <li>
                      <Link to="">
                        Voltage Wave Energy <FaArrowRight />
                      </Link>
                    </li>
                  </ul>
                </div>
