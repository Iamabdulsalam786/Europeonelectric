                          ...
                          <Row>
                            <Col lg={3}>
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  ...
                                  <Link className="header-btn7" to="/single-page/home-1" target="_blank">
                                    One Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                            ...
                            <Col lg={3}>
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="header-btn7" to="/home-2">
                                    Multi Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                                  ...
                                  <div className="space16" />
                                  <Link className="header-btn7" to="/single-page/home-2" target="_blank">
                                    One Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                            ...
                            <Col lg={3}>
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="header-btn7" to="/home-3">
                                    Multi Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                                  ...
                                  <div className="space16" />
                                  <Link className="header-btn7" to="/single-page/home-3" target="_blank">
                                    One Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                            ...
                            <Col lg={3}>
                              <div className="homemenu-thumb">
                                ...
                                <div className="homemenu-btn">
                                  <Link className="header-btn7" to="/home-4">
                                    Multi page
                                    <span>
                                      <FaArrowRight />
                                    </span>
                                  ...
                                  <div className="space16" />
                                  <Link className="header-btn7" to="/single-page/home-4" target="_blank">
                                    One Page
                                    <span>
                                      <FaArrowRight />
                                    </span>
