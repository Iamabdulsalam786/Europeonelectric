...
const sliderData: SliderType[] = [
  { image: tes2, name: 'Shakib Mahmud', rating: 5 },
  { image: tes3, name: 'Shakib Mahmud', rating: 5 },
  { image: tes4, name: 'Shakib Mahmud', rating: 5 },
  { image: tes5, name: 'Shakib Mahmud', rating: 5 },
  { image: tes1, name: 'Shakib Mahmud', rating: 5 },
  { image: tes2, name: 'Shakib Mahmud', rating: 5 },
  { image: tes3, name: 'Shakib Mahmud', rating: 5 },
  { image: tes4, name: 'Shakib Mahmud', rating: 5 },
  { image: tes5, name: 'Shakib Mahmud', rating: 5 },
                        ...
                        {sliderData.map((item, idx) => (
                          <div key={idx} className="testimonial3-slider-content-area">
                            <div className="testimonial3-author-area">
                              <ul className="d-flex justify-content-start gap-1">
                                <li>
                                  <Link to="">
                                    <FaStar />
                                  </Link>
