import contact2 from '@/assets/img/all-images/contact-bg2.png'
...
const Contact = () => {
  return (
    <>
      <div
        className="contact3-section-area sp1"
        style={{ backgroundImage: `url(${contact2})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
        <Container>
          <Row className="align-items-center">
            <Col lg={6}>
              <div className="contact-header-area heading7">
            ...
            <Col lg={6} data-aos="zoom-in" data-aos-duration={1200}>
