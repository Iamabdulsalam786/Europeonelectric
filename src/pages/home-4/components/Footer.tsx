...
import { FaArrowRight, FaEnvelope, FaFacebookF, FaInstagram, FaLinkedinIn, FaLocationDot, FaPhone, FaYoutube } from 'react-icons/fa6'
          ...
          <Row>
            <Col lg={12}>
              <Col lg={6} className="m-auto">
                <div className="cta-header heading2 text-center">
                  <h2 className="tg-element-title">Schedule A Free Consultation</h2>
                  <p data-aos="fade-up" data-aos-duration={800}>
                    Feel free to customize this paragraph to better reflect the specific <br className="d-lg-block d-none" /> services offered by your
                    IT solution &amp; the unique
                  </p>
                  <form action="#" data-aos="fade-up" data-aos-duration={1000}>
                    <input type="email" placeholder="Email Address" />
                    <button type="submit" className="header-btn5">
